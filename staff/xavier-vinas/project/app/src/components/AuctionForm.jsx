...
function AuctionForm({ }) {
    ...
    return <Container TagName="form" onSubmit={handleAddAuction} >
        ...
        <input className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline " type="date" id="startDate" name="startDate" required />

        <label className="block text-gray-700 font-bold mb-2" htmlFor="endDate">end date:</label>
        <input className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline " type="date" id="endDate" name="endDate" required />
