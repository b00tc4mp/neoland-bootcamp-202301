function TicTacToe(){
  ...
  const checkStatus=(b1,b2,b3,b4,b5,b6,b7,b8,b9) =>{
    if(b1 && b1===b2 && b2===b3) setResult(b1 +' winner')
    else if(b4 && b4===b5 && b5===b6) setResult(b4 + ' winner')
    else if (b7 && b7===b8 && b8===b9) setResult(b7 + 'winner')
    else if (b1 && b1===b4 && b4===b7) setResult(b1 +' winner')
    else if (b2 && b2===b5 && b5===b8) setResult(b2 +' winner')
    else if (b3 && b3===b6 && b6===b9) setResult(b3 +' winner')
    else if (b1 && b1===b5 && b5===b9) setResult(b1 +' winner')
    else if (b3 && b3===b5 && b5===b7) setResult(b3 +' winner')
