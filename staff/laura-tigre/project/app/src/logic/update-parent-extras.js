 ...
 * @param {string} newExtras The parent new description
 * @param {function} callback The function to call when the update is complete (or fails)
 */

function updateExtrasParent(token,newExtras, callback) {
    validateToken(token)
    ...
    xhr.open('PATCH',`${process.env.REACT_APP_API_URL}/parents/extras`)
  ...
  export default updateExtrasParent