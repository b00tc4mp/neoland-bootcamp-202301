const { validateToken, validatePassword, validateNewPassword, validateNewPasswordConfirm, validateCallback, ClientError, ServerError, ExistenceError, AuthError } = require('com')
