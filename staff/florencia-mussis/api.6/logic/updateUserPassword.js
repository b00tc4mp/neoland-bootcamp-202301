...
function updateUserPassword(userId, currentPassword, newPassword, newPasswordRepeat) {
    ...
    if (typeof newPasswordRepeat !== 'string') throw new Error('newPasswordConfirm is not a string')
    if (newPasswordRepeat.length < 8) throw new Error('newPasswordConfirm is shorter than 8 characters')
