    ...
    .then(() => {
        ...
        server.post('/users', jsonBodyParser, (req, res) => {
            try {
                ...
                registerUser(name, age, email, password)
                    ...
                    .catch(error => { // parte asincrona y viene del catch de las lógicas
            ...
            } catch (error) { // parte sincrona - viene de los validates y la parte sincrona de las logics
        ...
        server.patch('/users/password', jsonBodyParser, (req, res) => {
            try {
                ...
                if (error instanceof CoherenceError || error instanceof RangeError || error instanceof TypeError)
                    res.status(400)
                else
                    res.status(500)
