function Input({ children, className, TagName = 'input', ...restProps }) {
    ...
    return <TagName className={`px-4 py-2 m-2 border border-neutral-500 rounded-3xl focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-neutral-500 focus:border-neutral-500 sm:text-base font-roboto ${className}`} {...restProps}>{children}</TagName>
}
