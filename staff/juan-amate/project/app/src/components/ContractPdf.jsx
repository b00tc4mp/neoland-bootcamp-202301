...
function ContractPdf() {
    ...
    const loadPhotographer = () => {
        try {
            retrieveAdminUser(sessionStorage.token, (error, photographer) => {
                if (error) {
                    alert(error.message)
                ...
                <Document>
                    <Page
                        ...
                        {/* <View style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'left', backgroundColor: 'white', marginTop: '20px', wordBreak: 'keep-all' }}>
                            <Text style={{ color: 'black', fontSize: '12px', textAlign: 'left', marginHorizontal: '40px', marginTop: '60px', wordBreak: 'keep-all' }}>On the one hand {photographer.name} with national id: {photographer.nationalId} and registered office at {photographer.address} - {photographer.zipCode} - {photographer.city} ({photographer.province}), and phone: {photographer.phone}. Hereinafter referred to as THE PHOTOGRAPHER.</Text>
                            <Text style={{
                                color: 'black',
                                fontSize: '12px',
                                textAlign: 'left',
                    ...
                    {/* <Page
                        ...
                        <View style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'left', backgroundColor: 'white', marginTop: '20px', wordBreak: 'keep-all' }}>
                            ...
                            <Text style={{
                                ...
                                marginTop: '40px',
                                marginBottom: '40px'
                            }}>5. For any claim, the parties submit to the Courts and Tribunals of {photographer.city}.</Text>
                    ...
                    <Page
                        ...
                        <View style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', backgroundColor: 'white', marginHorizontal: '10px', padding: 10 }}>
                            ...
                            <Text style={{
                                ...
                                marginHorizontal: '30px',
                                marginTop: '80px'
                            }}>In {photographer.city}, on {contractDate}</Text>
                            <Text style={{
                                color: 'black',
                                fontSize: '11px',
                                marginHorizontal: '30px',
                            ...
                            <Text style={{
                                ...
                                marginHorizontal: '30px',
                                marginTop: '5px'
                            }}>{user.name} - {contract.coupleName} - {photographer.name}</Text>
                        </View>
                    </Page> */}
                </Document>
            </PDFViewer>
