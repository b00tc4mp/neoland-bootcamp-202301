                        ...
                        <Document>
                            <Page
                                ...
                                <View style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', backgroundColor: 'white', padding: 10 }}>
                                    <Text style={{
                                        color: 'black', fontSize: '20px', textAlign: 'center', fontWeight: 'bold', textTransform: 'uppercase', marginTop: '40px', marginBottom: '25px'
                                    }}>contract provision of services</Text>
                                    <Text style={{ color: 'black', fontSize: '15px', fontWeight: 'semibold', textTransform: 'uppercase', marginTop: '40px', marginBottom: '25px' }}>together</Text>
                                    ...
                                    <Text style={{ color: 'black', fontSize: '12px', textAlign: 'left', marginHorizontal: '30px', marginTop: '40px' }}>And on the other hand {user.name}, of legal age, with national id: {user.nationalId} with address at {user.address} - {user.nationalId} - {user.city} ({user.province}); phone: {user.phone} and email: {user.email}; and {contract.coupleName}, of legal age, with national id: {contract.coupleId}, phone: {contract.couplePhone} and email: {contract.coupleEmail}; hereinafter referred to as THE CLIENTS.</Text>
                                    <Text style={{
                                        color: 'black',
                                        fontSize: '15px',
                                        fontWeight: 'semibold',
